USE [master]
GO
/****** Object:  Database [jorgetomaschabrillon_LD6053dissertation]    Script Date: 05/08/2026 10:51:41 ******/
...
GO
/****** Object:  Table [dbo].[DimSponsorOrganisation]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Gold_ContractsFinder]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Dashboard_ContractsFinder]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Gold_GtRResearch]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Dashboard_GtRResearch]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Dashboard_Overview]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MatchComparison]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_MatchingComparisonSummary]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_AutomatedValidationEvidence]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT
    ...
    SUM(CASE WHEN IsDashboardEligible = 1 THEN 1 ELSE 0 END) AS DashboardEligibleRecords,
    AVG(CAST(FuzzyScorePercent AS FLOAT)) AS AverageFuzzyScorePercent,
    AVG(CAST(MLScorePercent AS FLOAT)) AS AverageMLScorePercent,
    SUM(CASE WHEN MethodsAgree = 1 THEN 1 ELSE 0 END) AS MethodsAgreeRecords,
    CAST(
        100.0 * SUM(CASE WHEN MethodsAgree = 1 THEN 1 ELSE 0 END) / NULLIF(COUNT(*), 0)
        AS DECIMAL(10,2)
...
GO
/****** Object:  Table [dbo].[DataLoadAudit]    Script Date: 05/08/2026 10:51:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
